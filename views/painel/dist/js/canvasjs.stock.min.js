...
( function () {
        ...
        if ( isNaN( u ) ) {
            try {
                ...
                if ( !wa ) {
                    ...
                    wa.innerHTML = "";
                    var D = document.createTextNode( "AroERP" );
                    wa.appendChild( D );
                    ra.appendChild( wa )
                }
                wa.style.display = "";
    ...
    function gb( h ) {
        if ( h._menuButton ) h.exportEnabled ? ( ga( h._menuButton, {
            backgroundColor: h.toolbar.itemBackgroundColor,
            color: h.toolbar.fontColor
        } ), Ka( h._menuButton ), h._menuButton.title = h._cultureInfo.menuText ) : ua( h._menuButton );
            ...
            J( h._menuButton, "mouseover", function () {
                ...
                } ), 0 >= navigator.userAgent.search( "MSIE" ) && ga( h._menuButton.childNodes[ 0 ], {
        ...
        if ( h.exportEnabled && h._dropdownMenu ) {
            ...
            w.innerHTML = h._cultureInfo.saveJPGText, w.style.backgroundColor = h.toolbar.itemBackgroundColor, w.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild( w ), J( w, "touchstart", function ( h ) {
                m = !0
            }, h.allDOMEventHandlers ), J( w, "mouseover", function () {
                m || ( this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover )
            }, h.allDOMEventHandlers, !0 ), J( w, "mouseout", function () {
                ...
                ua( h._dropdownMenu )
            }, h.allDOMEventHandlers, !0 ), w = document.createElement( "div" ), w.style.cssText = "padding: 12px 8px 12px 8px", w.innerHTML = h._cultureInfo.savePNGText, w.style.backgroundColor = h.toolbar.itemBackgroundColor, w.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild( w ), J( w, "touchstart", function ( h ) {
                m = !0
            }, h.allDOMEventHandlers ), J( w, "mouseover", function () {
    ...
    function hb( h ) {
        if ( !ib ) {
            ...
            "undefined" === typeof pa.Chart.creditHref ?
                ( h.creditHref = X( "iuuq;..`sndsq/bnl/cs." ), h.creditText = X( "@SN!E@RICN@SE" ) ) : ( m = h.updateOption( "creditText" ), w = h.updateOption( "creditHref" ) );
    ...
    function va( h, m, w ) {
        m.getAttribute( "state" ) || ( m.style.backgroundColor = h.toolbar.itemBackgroundColor, m.style.color = h.toolbar.fontColor, m.style.border = "none", ga( m, {
        ...
        m.getAttribute( "state" ) !==
            w && ( m.setAttribute( "state", w ), m.setAttribute( "type", "button" ), ga( m, {
                padding: "5px 12px",
                cursor: "pointer",
                "float": "left",
                width: "40px",
    ...
    function ya( h, m ) {
        ...
        if ( s( this.options.margin ) && h.options.subtitles )
            for ( var w = h.options.subtitles, u = 0; u < w.length; u++ )
                if ( ( s( w[ u ].horizontalAlign ) && "center" === this.horizontalAlign || w[ u ].horizontalAlign === this.horizontalAlign ) && ( s( w[ u ].verticalAlign ) && "top" === this.verticalAlign || w[ u ].verticalAlign === this.verticalAlign ) && !w[ u ].dockInsidePlotArea === !this.dockInsidePlotArea ) {
                    this.margin = 0;
                    break
                }
    ...
    var fb = function () {
        ...
        ea = function ( h, m, w ) {
            ...
            else "E" !== m[ 0 ] && "e" !== m[ 0 ] || "0" !== m[ m.length - 1 ] || !/[eE][+-]*[0]+/.test( m ) ? "," === m ? ( L++, F = J, J = 0, 0 < D.length &&
                ( w = y + w ) ) : w = 1 < m.length && ( '"' === m[ 0 ] && '"' === m[ m.length - 1 ] || "'" === m[ 0 ] && "'" === m[ m.length - 1 ] ) ? m.slice( 1, m.length - 1 ) + w : m + w : ( m = 0 > V ? m.replace( "+", "" ).replace( "-", "" ) : m.replace( "-", "" ), w += m.replace( /[0]+/, function ( a ) {
                return Y( V, a.length )
            } ) );
            y = "";
            for ( M = !1; 0 < T.length; ) m = T.shift(), "#" === m || "0" === m ? 0 < h.length && 0 !== Number( h.join( "" ) ) ? ( y += h.shift(), M = !0 ) : "0" === m && ( y += "0", M = !0 ) : 1 < m.length && ( '"' === m[ 0 ] && '"' === m[ m.length - 1 ] || "'" === m[ 0 ] && "'" === m[ m.length - 1 ] ) ? y += m.slice( 1, m.length - 1 ) : "E" !== m[ 0 ] && "e" !== m[ 0 ] || "0" !== m[ m.length -
                1 ] || !/[eE][+-]*[0]+/.test( m ) ? y += m : ( m = 0 > V ? m.replace( "+", "" ).replace( "-", "" ) : m.replace( "-", "" ), y += m.replace( /[0]+/, function ( a ) {
                return Y( V, a.length )
            } ) );
            w += ( M ? u : "" ) + y;
            return s ? "-" + w : w
        ...
        ca = function ( h, m, w, s, u, y, D, F, N, M, T, Q, J ) {
            ...
            h.restore();
            !0 === N && ( h.save(), h.beginPath(), h.moveTo( m, w ), h.lineTo( m + H, w + H ), h.lineTo( s - H, w + H ), h.lineTo( s, w ), h.closePath(), D = h.createLinearGradient( ( s + m ) / 2, w + H, ( s + m ) / 2, w ), D.addColorStop( 0, y ),
                D.addColorStop( 1, "rgba(255, 255, 255, .4)" ), h.fillStyle = D, h.fill(), h.restore() );
            !0 === M && ( h.save(), h.beginPath(), h.moveTo( m, u ), h.lineTo( m + H, u - H ), h.lineTo( s - H, u - H ), h.lineTo( s, u ), h.closePath(), D = h.createLinearGradient( ( s + m ) / 2, u - H, ( s + m ) / 2, u ), D.addColorStop( 0, y ), D.addColorStop( 1, "rgba(255, 255, 255, .4)" ), h.fillStyle = D, h.fill(), h.restore() );
            !0 === T && ( h.save(), h.beginPath(), h.moveTo( m, w ), h.lineTo( m + H, w + H ), h.lineTo( m + H, u - H ), h.lineTo( m, u ), h.closePath(), D = h.createLinearGradient( m + H, ( u + w ) / 2, m, ( u + w ) / 2 ), D.addColorStop( 0,
                y ), D.addColorStop( 1, "rgba(255, 255, 255, 0.1)" ), h.fillStyle = D, h.fill(), h.restore() );
            !0 === Q && ( h.save(), h.beginPath(), h.moveTo( s, w ), h.lineTo( s - H, w + H ), h.lineTo( s - H, u - H ), h.lineTo( s, u ), D = h.createLinearGradient( s - H, ( u + w ) / 2, s, ( u + w ) / 2 ), D.addColorStop( 0, y ), D.addColorStop( 1, "rgba(255, 255, 255, 0.1)" ), h.fillStyle = D, D.addColorStop( 0, y ), D.addColorStop( 1, "rgba(255, 255, 255, 0.1)" ), h.fillStyle = D, h.fill(), h.closePath(), h.restore() )
        },
        X = function ( h ) {
            for ( var m = "", s = 0; s < h.length; s++ ) m += String.fromCharCode( Math.ceil( h.length /
                57 / 5 ) ^ h.charCodeAt( s ) );
            return m
        },
    ...
    V.prototype.updateOption = function ( h ) {
        ...
        var m = pa[ this._defaultsKey ],
            ...
            H = this._index;
        this.theme && s( this.parent ) && s( F ) && s( H ) ? u = s( this.predefinedThemes[ this.theme ] ) ? this.predefinedThemes.light1 : this.predefinedThemes[ this.theme ] : this.parent && ( this.parent.themeOptions && this.parent.themeOptions[ F ] ) && ( null === H ? u = this.parent.themeOptions[ F ] : 0 < this.parent.themeOptions[ F ].length && ( u = Math.min( this.parent.themeOptions[ F ].length - 1, H ), u = this.parent.themeOptions[ F ][ u ] ) );
        this.themeOptions = u;
    ...
    ya.prototype.setLayout = function () {
        if ( this.text ) {
            ...
            M = H.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ( "top" === this.verticalAlign ? ( y = m.y1 + 2, J = "top" ) : "bottom" === this.verticalAlign && ( y = m.y2 - 2 - M.height, J = "bottom" ), "left" === this.horizontalAlign ? u = m.x1 + 2 : "center" === this.horizontalAlign ? u = m.x1 + m.width / 2 - M.width / 2 : "right" === this.horizontalAlign && ( u = m.x2 - 2 - M.width - D ), N = this.horizontalAlign,
                this.width = M.width, this.height = M.height ) : "center" === this.verticalAlign && ( "left" === this.horizontalAlign ? ( u = m.x1 + 2, y = m.y2 - 2 - ( this.maxWidth / 2 - M.width / 2 ), F = -90, J = "left", this.width = M.height, this.height = M.width ) : "right" === this.horizontalAlign ? ( u = m.x2 - 2, y = m.y1 + 2 + ( this.maxWidth / 2 - M.width / 2 ), F = 90, J = "right", this.width = M.height, this.height = M.width ) : "center" === this.horizontalAlign && ( y = h.y1 + ( h.height / 2 - M.height / 2 ), u = h.x1 + ( h.width / 2 - M.width / 2 ), J = "center", this.width = M.width, this.height = M.height ), N = "center" );
            H.x =
                u;
            H.y = y;
            H.angle = F;
    ...
    y = Oa.Chart = function () {
        ...
        function w( a, d ) {
            for ( var c = [], b, e = 0; e < a.length; e++ )
                if ( 0 == e ) c.push( a[ 0 ] );
                    ...
                    var A = ( a[ l ].x - a[ f ].x ) / b;
                    b = ( a[ l ].y - a[ f ].y ) / b;
                    c[ c.length ] = a[ v ].x > a[ f ].x && 0 < A || a[ v ].x < a[ f ].x && 0 > A ? {
                        x: a[ v ].x + A / 3,
                        y: a[ v ].y + b / 3
                    } : {
                        x: a[ v ].x,
                    ...
                    J( this._resetButton, "click", function () {
                        ...
                        a.stockChart && ( a.stockChart._rangeEventParameter.type = "rangeChanged", a.stockChart.dispatchEvent( "rangeChanged", a.stockChart._rangeEventParameter, a.stockChart ) )
                            ...
                            d || ( ga( a._resetButton, {
                                ...
                                transition: "0.4s",
                                WebkitTransition: "0.4s"
                            } ), 0 >= navigator.userAgent.search( "MSIE" ) && ga( a._resetButton.childNodes[ 0 ], {
                                WebkitFilter: "invert(100%)",
                                filter: "invert(100%)"
                            } ) )
                        },
        ...
        m.prototype.calculateAutoBreaks = function () {
            ...
            for ( var b, e = this, f = !1, l = 0; l < this._axes.length; l++ )
                if ( this._axes[ l ].scaleBreaks && this._axes[ l ].scaleBreaks.autoCalculate && 1 <= this._axes[ l ].scaleBreaks.maxNumberOfAutoBreaks ) {
                    ...
                    for ( var v = 0; v < 100 / Math.max( parseFloat( this._axes[ l ].scaleBreaks.collapsibleThreshold ) || 10, 10 ); v++ ) this._axes[ l ].dataInfo._dataRanges.push( {
                        min: Infinity,
                        max: -Infinity
                    } )
                } if ( f ) {
        ...
        m.prototype._dispatchRangeEvent = function ( a, d ) {
            ...
            for ( var e = 0; e < b.length; e++ )
                ...
                for ( f = 0; f <
                    this.axisY2.length; f++ ) c[ b[ e ] ].push( {
                    viewportMinimum: this[ b[ e ] ][ f ].sessionVariables.newViewportMinimum,
                    viewportMaximum: this[ b[ e ] ][ f ].sessionVariables.newViewportMaximum
                } );
            else if ( "axisX" === b[ e ] )
        ...
        m.prototype.renderIndexLabels = function ( a ) {
            ...
            for ( a = 0; a < this._indexLabels.length; a++ ) {
                ...
                if ( null !== C && "" !== C ) {
                    ...
                    } else if ( n.dataPoint.x < e.viewportMinimum || n.dataPoint.x >
                        ...
                        for ( var B = !1, t = 0; t < n.length; t++ )
                            if ( x = n[ t ].getTime ? n[ t ].x.getTime() : n[ t ].x, !( x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                                ...
                                if ( "number" !== typeof n[ t ].y ) 0 < t && !( k.connectNullData || B || m ) && ( c.stroke(), u && b.stroke() ), B = !0;
                                    ...
                                    if ( 0 < n[ t ].markerSize || 0 < k.markerSize ) C = k.getMarkerProperties( t, x, s, c ), f.push( C ), z = Q( z ), u && f.push( {
                                        x: x,
                                        y: s,
                                        ctx: b,
                                        type: C.type,
                        ...
                        for ( var h = 5 < p && g.bevelEnabled ? !0 : !1, f =
                            ...
                            if ( r[ f ].getTime ? A = r[ f ].x.getTime() : A = r[ f ].x, !( A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax ) && "number" === typeof r[ f ].y ) {
                                ...
                                ( r[ f ].indexLabel || g.indexLabel || r[ f ].indexLabelFormatter || g.indexLabelFormatter ) && this._indexLabels.push( {
                                    ...
                                    point: {
                                        x: l + ( m - l ) / 2,
                                        y: 0 > r[ f ].y === a.axisY.reversed ? v : t
                                    },
                                    direction: 0 > r[ f ].y ===
                    ...
                    if ( 0 < t.length ) {
                        ...
                        for ( k = 0; k < t.length; k++ )
                            if ( b = t[ k ].x.getTime ? t[ k ].x.getTime() :
                                ...
                                b = Q( b );
                                u && ca( this._eventManager.ghostCtx, C, s, n, B, b, 0, null, !1, !1, !1,
                                    !1 );
                                ( t[ k ].indexLabel || m.indexLabel || t[ k ].indexLabelFormatter || m.indexLabelFormatter ) && this._indexLabels.push( {
        ...
        m.prototype.renderArea = function ( a ) {
            ...
            function b() {
                C && ( 0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = E : 0 > a.axisY.viewportMaximum ? B = v.y1 : 0 < a.axisY.viewportMinimum && ( B = E ), f.lineTo( m, B ), f.lineTo( C.x, B ), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, u && ( l.lineTo( m, B ), l.lineTo( C.x, B ), l.closePath(), l.fill() ), f.beginPath(), f.moveTo( m, t ), l.beginPath(), l.moveTo( m, t ), C = {
                    x: m,
                    y: t
                } )
            }
            ...
            if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
                        ...
                        for ( var ja = !0; h < r.length; h++ )
                            if ( s = r[ h ].x.getTime ? r[ h ].x.getTime() : r[ h ].x, !( s < a.axisX.dataInfo.viewPortMin ||
                                ...
                                if ( "number" !== typeof r[ h ].y ) g.connectNullData || ( ja || d ) || b(), ja = !0;
                                    ...
                                    d || ja ? ( !d && g.connectNullData ? ( f.setLineDash && ( g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType ) && ( d = m, c = t, m = n.x, t = n.y, b(), f.moveTo( n.x, n.y ), m = d, t = c, C = n, c = g.nullDataLineDashType, f.setLineDash( S ) ), f.lineTo( m, t ), u && l.lineTo( m, t ) ) : ( f.beginPath(), f.moveTo( m, t ), u &&
                                        ( l.beginPath(), l.moveTo( m, t ) ), C = {
                                            x: m,
                                            y: t
                                        } ), ja = d = !1 ) : ( f.lineTo( m, t ), u && l.lineTo( m, t ), 0 == h % 250 && b() );
                                    n = {
                                        x: m,
                                        y: t
                                    };
                                    ...
                                    0 !==
                                        r[ h ].markerSize && ( 0 < r[ h ].markerSize || 0 < g.markerSize ) && ( s = g.getMarkerProperties( h, m, t, f ), A.push( s ), aa = Q( aa ), u && A.push( {
                                            x: m,
                                            y: t,
                                            ctx: l,
                                            type: s.type,
                ...
                u && ( e.drawImage( this._preRenderCanvas, 0, 0,
        ...
        m.prototype.renderStepArea = function ( a ) {
            ...
            function b() {
                C && ( 0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = E : 0 > a.axisY.viewportMaximum ? B = v.y1 : 0 < a.axisY.viewportMinimum && ( B = E ), f.lineTo( m, B ), f.lineTo( C.x, B ), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, u && ( l.lineTo( m, B ), l.lineTo( C.x,
                    B ), l.closePath(), l.fill() ), f.beginPath(), f.moveTo( m, t ), l.beginPath(), l.moveTo( m, t ), C = {
                    x: m,
                    y: t
                } )
            }
                        ...
                        for ( ; h < r.length; h++ )
                            if ( s = r[ h ].x.getTime ? r[ h ].x.getTime() : r[ h ].x, !( s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && ( !g.connectNullData || !c ) ) ) {
                                ...
                                "number" !== typeof r[ h ].y ? ( g.connectNullData || ( c || d ) || b(), c = !0 ) : ( m = a.axisX.convertValueToPixel( s ), t = a.axisY.convertValueToPixel( r[ h ].y ), d || c ? ( !d && g.connectNullData ? ( f.setLineDash && ( g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType ) && ( d = m, c = t, m = n.x, t = n.y, b(),
                                    f.moveTo( n.x, n.y ), m = d, t = c, C = n, S = g.nullDataLineDashType, f.setLineDash( P ) ), f.lineTo( m, aa ), f.lineTo( m, t ), u && ( l.lineTo( m, aa ), l.lineTo( m, t ) ) ) : ( f.beginPath(), f.moveTo( m, t ), u && ( l.beginPath(), l.moveTo( m, t ) ), C = {
                                    x: m,
                                    y: t
                                } ), c = d = !1 ) : ( f.lineTo( m, aa ), u && l.lineTo( m, aa ), f.lineTo( m, t ), u && l.lineTo( m, t ), 0 == h % 250 && b() ), n = {
                                    x: m,
                                    y: t
                                    ...
                                    x1: m,
                                    y1: t
                                }, 0 !== r[ h ].markerSize && ( 0 < r[ h ].markerSize || 0 < g.markerSize ) && ( aa = g.getMarkerProperties( h, m, t, f ), A.push( aa ), s = Q( s ), u && A.push( {
                                    x: m,
                                    y: t,
                                    ctx: l,
                                    type: aa.type,
                ...
                for ( B = 0; B < a.dataSeriesIndexes.length; B++ ) {
                    ...
                    if ( 0 < n.length ) {
                        ...
                        for ( var aa = !0, q = 0; q < n.length; q++ ) {
                            var f = n[ q ],
                                fa = null,
                                fa = 0 <= z.dataPointIndexes[ f ] ? w[ z.dataPointIndexes[ f ] ] : {
                                    x: f,
                                    y: null
                                };
                            if ( !( f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && ( !z.connectNullData || !aa ) ) )
                                if ( "number" !== typeof fa.y ) z.connectNullData || ( aa || x ) || d(), aa = !0;
                                    ...
                                    h[ f ] = m - r;
                                    x || aa ? ( !x && z.connectNullData ? ( b.setLineDash && ( z.options.nullDataLineDashType || E === z.lineDashType && z.lineDashType !== z.nullDataLineDashType ) && ( x = k.pop(), E = k[ k.length - 1 ], d(), b.moveTo( t.x, t.y ), k.push( E ), k.push( x ), E = z.nullDataLineDashType, b.setLineDash( P ) ), b.lineTo( g,
                                        r ), u && s.lineTo( g, r ) ) : ( b.beginPath(), b.moveTo( g, r ), u && ( s.beginPath(), s.moveTo( g, r ) ) ), aa = x = !1 ) : ( b.lineTo( g, r ), u && s.lineTo( g, r ), 0 == q % 250 && ( d(), b.moveTo( g, r ), u && s.moveTo( g, r ), k.push( {
                                        x: g,
                                        y: m - ma
                                    } ) ) );
                                    t = {
                                    ...
                                    q < w.length - 1 && ( S !== ( w[ q ].lineColor || y ) || E !== ( w[ q ].lineDashType || z.lineDashType ) ) && ( d(), b.beginPath(), b.moveTo( g, r ), k.push( {
                                        x: g,
                                        y: m - ma
                                    } ), S = w[ q ].lineColor || y, b.strokeStyle = S, b.setLineDash && ( w[ q ].lineDashType ? ( E = w[ q ].lineDashType, b.setLineDash( N( E, z.lineThickness ) ) ) : ( E = z.lineDashType, b.setLineDash( D ) ) ) );
                                    ...
                                    0 <= z.dataPointIndexes[ f ] && 0 !== fa.markerSize && ( 0 < fa.markerSize || 0 < z.markerSize ) && ( ma = z.getMarkerProperties( z.dataPointIndexes[ f ], g, r, b ), l.push( ma ), f = Q( F ), u && l.push( {
                                        x: g,
                                        y: r,
                                        ctx: s,
                                        type: ma.type,
                                    ...
                                    ( fa.indexLabel || z.indexLabel || fa.indexLabelFormatter ||
                                        z.indexLabelFormatter ) && this._indexLabels.push( {
                            ...
                            if ( !( f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && ( !z.connectNullData || !aa ) ) )
                                if ( "number" !== typeof fa.y ) z.connectNullData ||
                                    ...
                                    s || aa ? ( !s && z.connectNullData ? ( b.setLineDash && ( z.options.nullDataLineDashType || t === z.lineDashType &&
                                        z.lineDashType !== z.nullDataLineDashType ) && ( s = k.pop(), t = k[ k.length - 1 ], d(), b.moveTo( m.x, m.y ), k.push( t ), k.push( s ), t = z.nullDataLineDashType, b.setLineDash( P ) ), b.lineTo( g, r ), u && E.lineTo( g, r ) ) : ( b.beginPath(), b.moveTo( g, r ), u && ( E.beginPath(), E.moveTo( g, r ) ) ), aa = s = !1 ) : ( b.lineTo( g, r ), u && E.lineTo( g, r ), 0 == q % 250 && ( d(), b.moveTo( g, r ), u && E.moveTo( g, r ), k.push( {
                                        x: g,
                                        y: x - ba
                                    } ) ) );
                                    m = {
                                    ...
                                    q < y.length - 1 && ( S !== ( y[ q ].lineColor || D ) || t !== ( y[ q ].lineDashType || z.lineDashType ) ) && ( d(), b.beginPath(), b.moveTo( g, r ), k.push( {
                                        ...
                                        y: x -
                                            ba
                                    } ), S = y[ q ].lineColor || D, b.strokeStyle = S, b.setLineDash && ( y[ q ].lineDashType ? ( t = y[ q ].lineDashType, b.setLineDash( N( t, z.lineThickness ) ) ) : ( t = z.lineDashType, b.setLineDash( F ) ) ) );
                                    if ( 0 <= z.dataPointIndexes[ f ] ) {
                                    ...
                                    0 <= z.dataPointIndexes[ f ] && 0 !== fa.markerSize && ( 0 < fa.markerSize || 0 < z.markerSize ) && ( ba = z.getMarkerProperties( q, g, r, b ), v.push( ba ), f = Q( G ),
                                        u && v.push( {
                                            x: g,
                                            y: r,
                                            ctx: E,
                            ...
                            if ( f = n[ e ].getTime ? f = n[ e ].x.getTime() : f = n[ e ].x, !( f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax ) && "number" === typeof n[ e ].y ) {
                                ...
                                Math.sqrt( ( p - f ) * ( p - f ) + ( q - l ) * ( q - l ) ) < Math.min( g.size, 5 ) && n.length > Math.min( this.plotArea.width,
                                    this.plotArea.height ) || ( p = k.dataPointIds[ e ], this._eventManager.objectMap[ p ] = {
                                        ...
                                        x1: f,
                                        y1: l
                                    }, p = Q( p ), u && W.drawMarker( g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness ), ( n[ e ].indexLabel || k.indexLabel || n[ e ].indexLabelFormatter || k.indexLabelFormatter ) && this._indexLabels.push( {
                                        chartType: "scatter",
                                        dataPoint: n[ e ],
                                        dataSeries: k,
                                        point: {
                    ...
                    if ( 0 < x.length )
                        for ( var E = 5 < r && t.bevelEnabled ? !0 : !1, v = 0; v < x.length; v++ )
                            if ( x[ v ].getTime ? g = x[ v ].x.getTime() : g = x[ v ].x, !( g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax ) && !s( x[ v ].y ) && x[ v ].y.length && "number" === typeof x[ v ].y[ 0 ] &&
                                ...
                                "candlestick" === t.type ? ( c.moveTo( h - y, n ), c.lineTo( h - y, Math.min( k, q ) ), c.stroke(), c.moveTo( h - y, Math.max( k, q ) ), c.lineTo( h - y, p ), c.stroke(), ca( c, B, Math.min( k, q ), C, Math.max( k, q ), x[ v ].y[ 0 ] <= x[ v ].y[ 3 ] ? t.risingColor : f, z, e, E, E, !1, !1, t.fillOpacity ), u && ( e = Q( D ), b.strokeStyle = e, b.moveTo( h - y, n ), b.lineTo( h - y, Math.min( k,
                                    q ) ), b.stroke(), b.moveTo( h - y, Math.max( k, q ) ), b.lineTo( h - y, p ), b.stroke(), ca( b, B, Math.min( k, q ), C, Math.max( k, q ), e, 0, null, !1, !1, !1, !1 ) ) ) : "ohlc" === t.type && ( c.moveTo( h - y, n ), c.lineTo( h - y, p ), c.stroke(), c.beginPath(), c.moveTo( h, k ), c.lineTo( B, k ), c.stroke(), c.beginPath(), c.moveTo( h, q ), c.lineTo( C, q ), c.stroke(), u && ( e = Q( D ), b.strokeStyle = e, b.moveTo( h - y, n ), b.lineTo( h - y, p ), b.stroke(), b.beginPath(), b.moveTo( h, k ), b.lineTo( B, k ), b.stroke(), b.beginPath(), b.moveTo( h, q ), b.lineTo( C, q ), b.stroke() ) );
                                ( x[ v ].indexLabel || t.indexLabel ||
                                    x[ v ].indexLabelFormatter || t.indexLabelFormatter ) && this._indexLabels.push( {
                                    chartType: t.type,
                                    dataPoint: x[ v ],
                                    dataSeries: t,
                                    point: {
                        ...
                        for ( var B = 5 < r && x.bevelEnabled ? !0 : !1, l = 0; l < E.length; l++ )
                            if ( E[ l ].getTime ? g = E[ l ].x.getTime() : g = E[ l ].x, !( g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax ) && !s( E[ l ].y ) && E[ l ].y.length && "number" === typeof E[ l ].y[ 0 ] && "number" === typeof E[ l ].y[ 1 ] && "number" === typeof E[ l ].y[ 2 ] && "number" === typeof E[ l ].y[ 3 ] && "number" === typeof E[ l ].y[ 4 ] && 5 === E[ l ].y.length ) {
                                ...
                                var C = v - r / 2 << 0,
                                    ...
                                    H = E[ l ].stemDashType ? E[ l ].stemDashType :
                                    x.stemDashType,
                                ...
                                c.save();
                                0 < ba && ( c.beginPath(), c.strokeStyle = ma, c.lineWidth = ba, c.setLineDash && c.setLineDash( N( H, ba ) ), c.moveTo( v - G, k ), c.lineTo( v - G, h ), c.stroke(), c.moveTo( v - G, p ), c.lineTo( v - G, n ), c.stroke() );
                                c.restore();
                                ...
                                c.restore();
                                c.save();
                                0 < P && ( c.beginPath(), c.setLineDash && c.setLineDash( N( F, P ) ), c.strokeStyle = S, c.lineWidth = P, c.moveTo( v - aa / 2 << 0, p - fa ), c.lineTo( v + aa / 2 << 0, p - fa ),
                                    c.stroke(), c.moveTo( v - aa / 2 << 0, h + fa ), c.lineTo( v + aa / 2 << 0, h + fa ), c.stroke() );
                                c.restore();
                                u && ( e = Q( O ), b.strokeStyle = e, b.lineWidth = ba, 0 < ba && ( b.moveTo( v - D - G, k ), b.lineTo( v - D - G, Math.max( h, p ) ), b.stroke(), b.moveTo( v - D - G, Math.min( h, p ) ), b.lineTo( v - D - G, n ), b.stroke() ), ca( b, C, Math.max( k, n ), z, Math.min( k, n ), e, 0, null, !1, !1, !1, !1 ), 0 < P && ( b.beginPath(), b.lineWidth = P, b.moveTo( v + aa / 2, p - fa ), b.lineTo( v - aa / 2, p - fa ), b.stroke(), b.moveTo( v + aa / 2, h + fa ), b.lineTo( v - aa / 2, h + fa ), b.stroke() ) );
                        ...
                        if ( 0 < C.length )
                            for ( var F = B._colorSet, v = 0; v < C.length; v++ ) {
                                ...
                                if ( !( r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax ) && !s( C[ v ].y ) && C[ v ].y.length && "number" === typeof C[ v ].y[ 0 ] && "number" === typeof C[ v ].y[ 1 ] ) {
                                    ...
                                    b ? p = ja : g = ja;
                                    b ? ( q = a.axisX.reversed ? k + ( z ? w :
                                        1 ) * t / 2 - ( z ? D - 1 : 0 ) * t << 0 : k - ( z ? w : 1 ) * t / 2 + ( z ? D - 1 : 0 ) * t << 0, g = a.axisX.reversed ? q - t << 0 : q + t << 0 ) : ( n = a.axisX.reversed ? h + ( z ? w : 1 ) * t / 2 - ( z ? D - 1 : 0 ) * t << 0 : h - ( z ? w : 1 ) * t / 2 + ( z ? D - 1 : 0 ) * t << 0, p = a.axisX.reversed ? n - t << 0 : n + t << 0 );
                                    !b && q > g && ( ja = q, q = g, g = ja );
                                    b && n > p && ( ja = n, n = p, p = ja );
                                    ja = B.dataPointIds[ v ];
                                    ...
                                    if ( C[ v ].indexLabel || B.indexLabel || C[ v ].indexLabelFormatter || B.indexLabelFormatter ) this._indexLabels.push( {
                                            chartType: "error",
                                            dataPoint: C[ v ],
                                            dataSeries: B,
                                            indexKeyword: 0,
                                            point: {
                                                x: b ? C[ v ].y[ 1 ] >= C[ v ].y[ 0 ] ? n : p : n + ( p - n ) / 2,
                                                y: b ? q + ( g - q ) / 2 : C[ v ].y[ 1 ] >= C[ v ].y[ 0 ] ? g : q
                                            },
                                        ...
                                        this._indexLabels.push( {
                                            ...
                                            indexKeyword: 1,
                                            point: {
                                                x: b ? C[ v ].y[ 1 ] >= C[ v ].y[ 0 ] ? p : n : n + ( p - n ) / 2,
                                                y: b ? q + ( g - q ) / 2 : C[ v ].y[ 1 ] >= C[ v ].y[ 0 ] ? q : g
                                            },
                                            direction: C[ v ].y[ 1 ] >= C[ v ].y[ 0 ] ? 1 : -1,
                                            bounds: {
                                                x1: b ? Math.min( n, p ) : n,
                        ...
                        for ( var S = !0; g < p.length; g++ )
                            if ( t = p[ g ].x.getTime ? p[ g ].x.getTime() : p[ g ].x, !( t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && ( !n.connectNullData || !S ) ) )
                                if ( null !== p[ g ].y && p[ g ].y.length && "number" === typeof p[ g ].y[ 0 ] && "number" === typeof p[ g ].y[ 1 ] ) {
                                    ...
                                    q || S ? ( n.connectNullData && !q ? ( b.setLineDash && ( n.options.nullDataLineDashType || z === n.lineDashType &&
                                        n.lineDashType !== n.nullDataLineDashType ) && ( m[ m.length - 1 ].newLineDashArray = D, z = n.nullDataLineDashType, b.setLineDash( y ) ), b.lineTo( r, s ), u && e.lineTo( r, s ), m.push( {
                                        x: r,
                                        y1: s,
                                        y2: w
                                    } ) ) : ( b.beginPath(), b.moveTo( r, s ), x = {
                                        x: r,
                                        y: s
                                    }, m = [], m.push( {
                                        x: r,
                                        y1: s,
                                        y2: w
                                    } ), u && ( e.beginPath(), e.moveTo( r, s ) ) ), S = q = !1 ) : ( b.lineTo( r, s ), m.push( {
                                        x: r,
                                        y1: s,
                                        y2: w
                                    } ), u && e.lineTo( r, s ), 0 == g % 250 && d() );
                                    t = n.dataPointIds[ g ];
                                    this._eventManager.objectMap[ t ] = {
                                        id: t,
                                        objectType: "dataPoint",
                    ...
                    if ( 0 < w.length )
                        for ( var E = 5 < q && s.bevelEnabled ? !0 : !1, B = !1, y = null, z = null, l = 0; l < w.length; l++ )
                            if ( w[ l ].getTime ?
                                ...
                                e = Q( e );
                                u && ca( this._eventManager.ghostCtx, h, m, F, k, e, 0, null, !1,
                                    !1, !1, !1 );
                                var P, S = h;
                                ...
                                0 < l && y && ( !B || s.connectNullData ) && ( B && c.setLineDash && c.setLineDash( N( D, t ) ), c.beginPath(), c.moveTo( y, z - x ), c.lineTo( S, P - x ), 0 < t && c.stroke(), u && ( b.beginPath(), b.moveTo( y, z - x ), b.lineTo( S, P - x ), 0 < t && b.stroke() ) );
                                B = !1;
                                y = F;
                                z = 0 < w[ l ].y ? m : k;
            ...
            function d() {
                if ( k && n ) {
                    for ( var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++ ) {
                        ...
                        if ( k.indexLabelFormatter || f.indexLabelFormatter ) v = {
                            chart: m.options,
                            dataSeries: k,
                            dataPoint: f,
                            total: h.total,
            ...
            function c( a ) {
                ...
                for ( b = 0; b < n.length; b++ ) {
                    ...
                    if ( d > c ) {
                        ...
                        } else if ( 0 < Math.abs( g[ b ].center.x - E.x ) || 0 < Math.abs( g[ b ].center.y - E.y ) ) g[ b ].center.x = E.x + e * ( 1 - a ), g[ b ].center.y = E.y + f * ( 1 - a ),
                            l = !0;
                ...
                if ( 0 <= a && a < n.length ) {
                    ...
                    for ( p = 1; p < n.length; p++ )
                        if ( l = ( a - p + g.length ) % g.length, g[ l ].hemisphere !== g[ a ].hemisphere ) {
                            l = null;
                            break
                        } else if ( g[ l ].indexLabelText && g[ l ].hemisphere ===
                        ...
                        for ( var v, s, a = 0; a < n.length; a++ ) {
                            ...
                            if ( null !== t ) {
                                ...
                                if ( 0 > B ) {
                                    ...
                                    var y = -1 * ( B - s ),
                                        H = C = 0;
                                    "right" === h.hemisphere ? ( C = f( a, s ), y = -1 * ( B - C ), H = f( t, y ), +H.toFixed( x ) <
                                        +y.toFixed( x ) && +C.toFixed( x ) <= +s.toFixed( x ) && f( a, -( y - H ) ) ) : ( C = f( t, s ), y = -1 * ( B - C ), H = f( a, y ), +H.toFixed( x ) < +y.toFixed( x ) && +C.toFixed( x ) <= +s.toFixed( x ) && f( t, -( y - H ) ) )
                                }
                            }
                        }
                    } else
        ...
        m.prototype.renderFunnel =
            function ( a ) {
                ...
                function b() {
                    if ( t && x ) {
                        for ( var a, b, c, d, e, f, k, l, n, h, p, q, m, v, r, A = [], w = [], E = {
                                percent: null,
                                total: null
                            }, B = null, z = 0; z < x.length; z++ ) r = O[ z ],
                ...
                function f() {
                    ...
                    if ( "inside" !== t.indexLabelPlacement )
                        for ( var e = 0; e < O.length; e++ ) 0 == I[ e ].textBlock.text.length ? I[ e ].isDirty = !0 : ( a = O[ e ], c = "undefined" !== typeof a.x5 ? ( a.y2 + a.y4 ) / 2 : ( a.y2 + a.y3 ) / 2, b = t.reversed ? "undefined" !== typeof a.x5 ? c > xa ? g( c ).x2 + 1 : ( a.x2 + a.x3 ) / 2 + 1 : ( a.x2 + a.x3 ) / 2 + 1 : "undefined" !== typeof a.x5 ? c < xa ? g( c ).x2 + 1 : ( a.x4 + a.x3 ) / 2 + 1 : ( a.x2 + a.x3 ) / 2 + 1, I[ e ].textBlock.x = b + V, I[ e ].textBlock.y = c - I[ e ].height / 2, t.reversed ? ( I[ e ].textBlock.y + I[ e ].height > na + B && ( I[ e ].textBlock.y = na + B - I[ e ].height ), I[ e ].textBlock.y < sa - B && ( I[ e ].textBlock.y =
                ...
                var y = this;
                if ( !( 0 >= a.dataSeriesIndexes.length ) ) {
                    for ( var t = this.data[ a.dataSeriesIndexes[ 0 ] ], x = t.dataPoints, E = this.plotArea, B = 0.025 * E.width, C = 0.01 * E.width, z = 0, D = E.height - 2 * B, F = Math.min( E.width - 2 * C, 2.8 * E.height ), H = !1, P = 0; P < x.length; P++ )
                        if ( !H && ( "undefined" !== typeof x[ P ].indexLabel && null !== x[ P ].indexLabel && 0 < x[ P ].indexLabel.toString().length ) && ( H = !0 ), !H && ( "undefined" !== typeof x[ P ].label && null !== x[ P ].label && 0 < x[ P ].label.toString().length ) && ( H = !0 ), !H && "function" === typeof t.indexLabelFormatter ||
                            "function" === typeof x[ P ].indexLabelFormatter ) H = !0;
                    ...
                    if ( 0 != t.length && ( t.dataPoints && t.visible ) && 0 !== x.length ) {
                        ...
                        if ( -1 !== P ) {
                            ...
                            if ( t.reversed )
                                for ( G = 0; G < P.length; G++ ) F[ G ] < xa ? ( a.push( K ), C.push( W ), ca = G ) : ( a.push( ( F[ G ] - na + $ * Y ) / $ ), C.push( ( F[ G ] - na + ea * Z ) / ea ) );
                            else
                                for ( G = 0; G < P.length; G++ ) F[ G ] < xa ? ( a.push( ( F[ G ] - na + $ * Y ) / $ ), C.push( ( F[ G ] - na + ea * Z ) / ea ), ca = G ) : ( a.push( K ), C.push( W ) );
        ...
        m.prototype.replaceKeywordsWithValue = function ( a, d, c, b, e ) {
            ...
            return a.replace( /\{.*?\}|"[^"]*"|'[^']*'/g, function ( a ) {
                ...
                if ( "x" === a )
                    if ( c.axisX && "dateTime" ===
                        c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime ) {
                ...
                for ( n = 0; n < m.length; n++ ) {
                    ...
                    if ( !( 0 >= l || "undefined" === typeof l || 0 >= w || "undefined" === typeof w ) ) {
                        if ( "horizontal" === this.orientation ) {
                            ...
                            if ( !p || p.width + Math.round( q.textBlock.width + u + h + ( 0 === p.width ? 0 : this.horizontalSpacing ) + ( "line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0 ) ) > f ) p = {
                                items: [],
                                width: 0
                            ...
                            new ia( this.ctx, {
                                ...
                                fontStyle: this.fontStyle,
                                textBaseline: "middle"
                            } ), q.textBlock.measureText(), null !== this.itemWidth && ( q.textBlock.width = this.itemWidth - ( u + h + ( "line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0 ) ) ), this.height < l - this.lineHeight ? ( p = {
                                items: [],
                                width: 0
        ...
        D.setLayout = function ( a, d, c, b, e, f ) {
            ...
            for ( var w = u = 0, t = 0, x = 0, y = 0, B = 0, C = 0, z, D, F = h = 0, H, J, L, r = H = J = L = !1, g = 0; g < q.length; g++ ) q[ g ] && q[ g ].title && ( q[ g ]._titleTextBlock = new ia( q[ g ].ctx, {
                text: q[ g ].title,
                horizontalAlign: "center",
            ...
            if ( "normal" === e ) {
                for ( var x = [], y = [], B = [], C = [], M = [], N = [], Q = [], R = []; 4 >
                    ...
                    if ( a && 0 < a.length )
                        for ( g =
                            0; g < a.length; g++ ) a[ g ] && ( a[ g ].lineCoordinates.x1 = l, m = Math.round( f.x2 - $ - Z > n.width - p ? n.width - p : f.x2 - $ - Z ), a[ g ]._labels && 1 < a[ g ]._labels.length && ( h = k = 0, k = a[ g ]._labels[ 1 ], h = "dateTime" === a[ g ].valueType ? a[ g ]._labels[ a[ g ]._labels.length - 2 ] : a[ g ]._labels[ a[ g ]._labels.length - 1 ], w = k.textBlock.width * Math.cos( Math.PI / 180 * Math.abs( k.textBlock.angle ) ) + ( k.textBlock.height - h.textBlock.fontSize / 2 ) * Math.sin( Math.PI / 180 * Math.abs( k.textBlock.angle ) ), t = h.textBlock.width * Math.cos( Math.PI / 180 * Math.abs( h.textBlock.angle ) ) + ( h.textBlock.height -
                                h.textBlock.fontSize / 2 ) * Math.sin( Math.PI / 180 * Math.abs( h.textBlock.angle ) ) ), !a[ g ] || ( !a[ g ].labelAutoFit || s( z ) || s( D ) || n.isNavigator || n.stockChart ) || ( h = 0, 0 < a[ g ].labelAngle ? D + t > m && ( h += 0 < a[ g ].labelAngle ? D + t - m - $ : 0 ) : 0 > a[ g ].labelAngle ? z - w < l && z - w < a[ g ].viewportMinimum && ( F = l - ( K + a[ g ].tickLength + B + z - w + a[ g ].labelFontSize / 2 ) ) : 0 === a[ g ].labelAngle && ( D + t > m && ( h = D + t / 2 - m - $ ), z - w < l && z - w < a[ g ].viewportMinimum && ( F = l - K - a[ g ].tickLength - B - z + w / 2 ) ), a[ g ].viewportMaximum === a[ g ].maximum && a[ g ].viewportMinimum === a[ g ].minimum && 0 < a[ g ].labelAngle &&
                    ...
                    if ( 0 < u ) {
                        ...
                        if ( c && 0 < c.length )
                            for ( g = 0; g < c.length; g++ ) J = Q[ u - 1 ][ g ] === Q[ u ][ g ] ? !0 : !1;
                        else J = !0;
                        if ( b && 0 < b.length )
                            for ( g = 0; g < b.length; g++ ) L = R[ u -
                                1 ][ g ] === R[ u ][ g ] ? !0 : !1;
                        else L = !0
                    }
                    if ( r && H && J && L ) break;
                ...
                if ( "xySwapped" === this.chart.plotInfo.axisPlacement ) {
                        ...
                        if ( this.parent.labels )
                            ...
                            if ( "axisX" === this.parent.type )
                                for ( r = this.parent.convertPixelToValue( {
                                        y: d
                                    } ), u = null, w = 0; w < this.parent.dataSeries.length; w++ )( u =
                                    this.parent.dataSeries[ w ].getDataPointAtX( r, !0 ) ) && 0 <= u.index && ( k.text = this.labelFormatter ? this.labelFormatter( {
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                                    value: x.dataPoint.x
                            ...
                            } ) : s( this.options.label ) ? Aa( c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo ) :
                    ...
                    if ( this.parent.labels )
                        ...
                        if ( "axisX" ===
                            ...
                            for ( r = this.parent.convertPixelToValue( {
                                    x: a
                                } ), u = null, w = 0; w < this.parent.dataSeries.length; w++ )( u = this.parent.dataSeries[ w ].getDataPointAtX( r, !0 ) ) && 0 <= u.index && ( k.text = this.labelFormatter ? this.labelFormatter( {
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: x.dataPoint.x
                        ...
                        crosshair: this.options,
                        value: x.dataPoint.x
                    } ) : s( this.options.label ) ? Aa( c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo ) : this.label : "number" === this.parent.valueType && ( k.text = this.labelFormatter ? this.labelFormatter( {
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: x.dataPoint.x
                    ...
                    for ( w = 0; w < this.parent.dataSeries.length; w++ )( u = this.parent.dataSeries[ w ].getDataPointAtX( r,
                        !0 ) ) && 0 <= u.index && ( u.dataSeries = this.parent.dataSeries[ w ], null !== u.dataPoint.y && u.dataSeries.visible && n.push( u ) );
                    if ( 0 === n.length ) return;
                    n.sort( function ( a, b ) {
                        return a.distance - b.distance
                    } );
                ...
                if ( "xySwapped" === this.chart.plotInfo.axisPlacement )
                    if ( "left" === this.parent._position || "right" === this.parent._position ) {
                        ...
                        if ( this.parent.labels )
                            ...
                            if ( "axisX" === this.parent.type )
                                for ( r = this.parent.convertPixelToValue( {
                                        y: d
                                    } ), u = null, w = 0; w < this.parent.dataSeries.length; w++ )( u = this.parent.dataSeries[ w ].getDataPointAtX( r, !0 ) ) && 0 <= u.index &&
                                    ( k.text = this.labelFormatter ? this.labelFormatter( {
                                        chart: this.chart,
                                        axis: this.parent.options,
                                        crosshair: this.options,
                    ...
                    if ( this.parent.labels )
                        ...
                        this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter( {
                            ...
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue( a )
                        } ) : s( this.options.label ) ? Aa( c ? c : this.parent.convertPixelToValue( a ), this.valueFormatString, this.chart._cultureInfo ) : this.label : "number" === this.parent.valueType && ( k.text = this.labelFormatter ? this.labelFormatter( {
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
